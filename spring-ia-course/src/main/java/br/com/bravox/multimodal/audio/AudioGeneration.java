package br.com.bravox.multimodal.audio;
...
public class AudioGeneration {
    ...
    public ResponseEntity<byte[]> generateSpeech(
        ...
        var audioBytes = audioSpeechModel
                .call(new SpeechPrompt(text, options))
                .getResult().getOutput();

        return ResponseEntity.ok()
                .header(CONTENT_TYPE, "audio/mpeg")
                .header(CONTENT_DISPOSITION, "attachment; filename=\"speech.mp3\"")
                .body(audioBytes);
    }
}
